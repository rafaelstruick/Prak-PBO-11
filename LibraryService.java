...
public class LibraryService {
    ...
    public void addBook(Book book) {
        books.add(book);
        System.out.println("Buku '" + book.getTitle() + "' telahditambahkan.");
    }
    ...
    public void removeBook(String isbn) {
        ...
        if (book != null) {
            books.remove(book);
            System.out.println("Buku '" + book.getTitle() + "' telahdihapus.");
        } else {
    ...
    public void borrowBook(String memberId, String isbn) {
        ...
        if (member != null && book != null && !book.isBorrowed()) {
            ...
            System.out.println("Peminjaman gagal. Buku mungkin sudahdipinjam atau data tidak ditemukan.");
        }
    }
    ...
    public void returnBook(String memberId, String isbn) {
        ...
        if (member != null && book != null && book.isBorrowed()) {
            ...
            if (member.getFine() > 0) {
                System.out.println("Total denda Anda: Rp" +
                        member.getFine());
            }
        } else {
            System.out.println("Pengembalian gagal. Buku mungkin belumdipinjam atau data tidak ditemukan.");
        }
    }
    ...
    public void listAvailableBooks() {
        ...
        for (Book book : books) {
            if (!book.isBorrowed()) {
                System.out.println("- " + book.getTitle() + " oleh " +
    ...
    public void listMembers() {
        if (members.isEmpty()) {
            ...
            for (Member member : members) {
                System.out.println("- Nama: " + member.getName() + ", ID: "
                        + member.getId());
